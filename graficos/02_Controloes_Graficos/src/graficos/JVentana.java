...
class manejador implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        jb.setText("Has Pulsado Modo Tradicional");
    }    
}
...
public class JVentana extends JFrame{ //Heredar Jframe, ya es suficiente para que se comporte como una ventana.
    ...
    private void inicializarcomponentes(){
        ...
        //2.clase anonima para manejar el evento
        ...
        //1.Asociar evento especifico del control del componente, con el escuchador...
        //Falta ahora establecer la relación entre el evento del boton, y el listener
        jb1.addActionListener(l);//ahora ya cerrara
        
        //2.Asociarlo a la forma tradicional
        manejador m=new manejador(jb1);
        jb1.addActionListener(m);
        
        //3. Exprsión lambda
        ActionListener lb=(e)->{jb1.setText("ha pulsado");};
